      ...
      try {
        ...
        setDayData(p => ({
          ...
          [selectedDay]: {
            ...
            beddingType: dailyCheck?.bedding_type ?? '',
            beddingLocation: dailyCheck?.bedding_location ?? '',
            chemicalsUsed: dailyCheck?.chemicals_notes === 'Yes',
            chemicalsType: dailyCheck?.chemicals_type ?? '',
            chemicalsLocation: dailyCheck?.chemicals_location ?? '',
    ...
    try {
      ...
      const { error: dailyError } = await supabase
        ...
        .upsert([{
          ...
          bedding_type: d.beddingType || null,
          bedding_location: d.beddingLocation || null,
          chemicals_notes: d.chemicalsUsed ? 'Yes' : null,
          chemicals_type: d.chemicalsType || null,
          chemicals_location: d.chemicalsLocation || null,
