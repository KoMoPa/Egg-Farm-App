      ...
      try {
        ...
        setDayData(p => ({
          ...
          [selectedDay]: {
            ...
            beddingUsed: !!dailyCheck?.bedding_notes,
            beddingType: (dailyCheck?.bedding_notes && dailyCheck.bedding_notes !== 'Yes') ? dailyCheck.bedding_notes : '',
            chemicalsUsed: !!dailyCheck?.chemicals_notes,
            chemicalsType: (dailyCheck?.chemicals_notes && dailyCheck.chemicals_notes !== 'Yes') ? dailyCheck.chemicals_notes : '',
    ...
    try {
      ...
      const { error: dailyError } = await supabase
        ...
        .upsert([{
          ...
          bedding_notes: d.beddingUsed ? (d.beddingType || 'Yes') : null,
          chemicals_notes: d.chemicalsUsed ? (d.chemicalsType || 'Yes') : null,
