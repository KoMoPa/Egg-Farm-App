            ...
            <div style={{ display: 'grid', gridTemplateColumns: (hasBedding && hasChemicals) ? '1fr 1fr' : '1fr', gap: '20px', marginBottom: '30px' }}>
                {hasBedding && <div>
                    ...
                    <input type="text" maxLength={20} value={data.beddingType}
                        ...
                        disabled={locked}
                        style={{ width: '100%', padding: '8px', border: '1px solid #ccc', ...(locked && inputLocked) }} />
                    <label style={{ display: 'block', marginTop: '10px', marginBottom: '5px', fontWeight: 'bold' }}>Bedding Location</label>
                    <input type="text" maxLength={30} value={data.beddingLocation}
                        onChange={(e) => onDayChange(day, 'beddingLocation', e.target.value)}
                        disabled={locked}
                        style={{ width: '100%', padding: '8px', border: '1px solid #ccc', ...(locked && inputLocked) }} />
                </div>}
                {hasChemicals && <div>
                    ...
                    <input type="text" maxLength={20} value={data.chemicalsType}
                        ...
                        disabled={locked}
                        style={{ width: '100%', padding: '8px', border: '1px solid #ccc', ...(locked && inputLocked) }} />
                    <label style={{ display: 'block', marginTop: '10px', marginBottom: '5px', fontWeight: 'bold' }}>Chemicals Location</label>
                    <input type="text" maxLength={30} value={data.chemicalsLocation}
                        onChange={(e) => onDayChange(day, 'chemicalsLocation', e.target.value)}
                        disabled={locked}
                        style={{ width: '100%', padding: '8px', border: '1px solid #ccc', ...(locked && inputLocked) }} />
                </div>}
            </div>
